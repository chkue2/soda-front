...
const API_URL = {
	...
	USER: {
		...
		REVIEW_INSERT_BANK: '/bank/user/review/insert',
		REVIEW_DETAIL_BANK: '/bank/user/review/:seq',
		REVIEW_UPDATE_BANK: '/bank/user/review/update/:seq',
		REVIEW_DELETE_BANK: '/bank/user/review/delete/:seq',
